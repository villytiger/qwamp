...
#ifndef QWMAPRAWSESSION_P_H
#define QWAMPRAWSESSION_P_H

#include <QWamp/qwamprawsession.h>

#include <QJsonArray>
#include <QSharedPointer>

QWAMP_NAMESPACE_BEGIN

class QWampRawSessionPrivate : public QObject {
	Q_OBJECT
	Q_DECLARE_PUBLIC(QWampRawSession)

	QWampRawSession* q_ptr;
	QIODevice* mIo;
	int mState;
	...
	QWampRawSessionPrivate(QIODevice* io);
	void start();
